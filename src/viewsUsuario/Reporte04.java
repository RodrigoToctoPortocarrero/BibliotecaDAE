 ...
 * @author BIENVENIDO
 */
public class Reporte04 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reporte04.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
